...
export default function ThreadPage({ params }: { params: Promise<ThreadParams> }) {
  ...
  useEffect(() => {
    if (projectName) {
      ...
      if (metaDescription) {
        metaDescription.setAttribute('content', `${projectName} - Public AI conversation shared from GameByte`);
      }
            ...
            <div className="flex-1">
              <div className="flex items-center gap-2">
                <div className="flex items-center justify-center w-6 h-6 rounded-md overflow-hidden bg-primary/10">
                  <Image src="/gamebyte-logo-color.png" alt="Kortix" width={16} height={16} className="object-contain"/>
                </div>
