    ...
    >
      <SectionHeader>
        <h2 className="text-3xl md:text-4xl font-medium tracking-tighter text-center text-balance">
          See GameByte in action
        </h2>
        <p className="text-muted-foreground text-center text-balance font-medium">
          Explore real-world examples of how GameByte completes complex tasks autonomously
        </p>
      </SectionHeader>
              ...
              <div className="mt-auto">
                ...
                <div className="w-full h-[160px] bg-accent/10">
                  <div className="relative w-full h-full overflow-hidden">
                    <img 
                      src={useCase.image || `https://placehold.co/800x400/f5f5f5/666666?text=GameByte+${useCase.title.split(' ').join('+')}`}
                      alt={`GameByte ${useCase.title}`}
